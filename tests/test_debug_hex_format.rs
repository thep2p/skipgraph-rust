...
use skipgraph::core::{Address, Identifier, MembershipVector};
...
fn test_identifier_debug_shows_hex_not_raw_bytes() {
    ...
    assert_eq!(
        debug_output,
        "450b67668d4ba6800374280766d3042c1aea22961563ecd88e7446218f85ae53"
    );
}
...
fn test_membership_vector_debug_shows_hex_not_raw_bytes() {
    let mem_vec_bytes = [
        81, 77, 192, 82, 129, 173, 87, 224, 233, 181, 134, 100, 170, 151, 59, 27, 241, 80, 96, 46,
    ...
    assert_eq!(
        debug_output,
        "514dc05281ad57e0e9b58664aa973b1bf150602e36eb391f610e88c33f659df0"
    );
}
